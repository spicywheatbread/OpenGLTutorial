...
int main() {
    ...
    // Shader Compilation
    Shader lightingShader("resources/shaders/phongLighting.vert", "resources/shaders/phongLighting.frag");
    Shader screenQuadShader("resources/shaders/screenQuad.vert", "resources/shaders/screenQuad.frag");
    ...
    */
    ...
    glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, screenWidth, screenHeight); // Allocate mem and specify internal format
    ...
    glEnableVertexAttribArray(1);
    glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, 4 * sizeof(GL_FLOAT), (void*)(2 * GL_FLOAT));
